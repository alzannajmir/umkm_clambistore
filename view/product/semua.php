...
<head>
    ...
    <title>Produk Kami | Baju</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha2/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-aFq/bzH65dt+w6FI2ooMVUpc+21e0SRygnTpmBvdBgSdnuTN7QbdgL+OapgHtvPp" crossorigin="anonymous">
    <link rel="stylesheet" href="../../src/stylesheet/listProduk.css">
...
<body>
    <div class="container mt-5">
        <div class="card">
            <img src="../../assets/images/Semua/flanel.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Flannel Kotak Hitam</h5>
        ...
        <div class="card">
            <img src="../../assets/images/Baju/kaos1.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Kaos Original Japan</h5>
                <p class="card-text">Rp. 180.000</p>
            </div>
        </div>
        <div class="card">
            <img src="../../assets/images/Semua/kemeja.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Kemeja Kantor</h5>
                <p class="card-text">Rp. 180.000 - 250.000</p>
            </div>
        </div>
        <div class="card">
            <img src="../../assets/images/Baju/kaos2.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Kaos Putih Tulisan</h5>
        ...
        <div class="card">
            <img src="../../assets/images/Baju/kaos3.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Kaos Crem Sablon Plastisol</h5>
                <p class="card-text">Rp. 135.000</p>
            </div>
        </div>
        <div class="card">
        ...
        <div class="card">
            <img src="../../assets/images/Baju/kaos4.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Baju Merah Jangan Sampe Lolos</h5>
                <p class="card-text">Rp. 135.000</p>
            </div>
        </div>
        <div class="card">
            <img src="../../assets/images/Semua/kupluk.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Ko*lok</h5>
                <p class="card-text">Rp. 135.000 - 150.000</p>
            </div>
        </div>
        <div class="card">
            <img src="../../assets/images/Baju/kaos5.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Kaos Taking Over Hitam</h5>
        ...
        <div class="card">
            <img src="../../assets/images/Semua/lanyard.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Lanyard</h5>
                <p class="card-text">Rp. 115.000 - 115.500</p>
            </div>
        </div>
        <div class="card">
            <img src="../../assets/images/Baju/kaos6.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card">
            <img src="../../assets/images/Baju/kaos7.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card">
            <img src="../../assets/images/Semua/sabuk.PNG" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Sabuk</h5>
                <p class="card-text">Rp. 150.000</p>
            </div>
        </div>
        <div class="card">
            <img src="../../assets/images/Baju/kaos8.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Kemeja Biru Work</h5>
        ...
        <div class="card">
            <img src="../../assets/images/Semua/top1.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Topi Pria</h5>
                <p class="card-text">Rp. 150.000</p>
            </div>
        </div>
        <div class="card">
        ...
        <div class="card">
            <img src="../../assets/images/Semua/top2.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Ko*lok</h5>
        ...
        <div class="card">
            <img src="../../assets/images/Baju/kaos9.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Polo Shirt SE</h5>
                <p class="card-text">Rp. 250.000</p>
            </div>
        </div>
        <div class="card">
